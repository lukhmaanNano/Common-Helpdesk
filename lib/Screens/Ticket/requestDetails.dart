...
import 'package:commonhelpdesk/styles/CommonSize.dart';
...
class _RequestDetailsState extends State<RequestDetails> {
  ...
  Widget web() {
    ...
    final time = timeFormat.format(currentDate!);
    return Padding(
                        ...
                        child: Column(
                          children: [
                            ...
                            Padding(
                              ...
                              child: Row(children: [
                                SizedBox(
                                  ...
                                  child:
                                      const Text("Contract", style: cardTitle),
                                ),
                                SizedBox(
                                    width: displayWidth(context) * 0.16,
                                    child: Text(
                                      ": ${trackVale[0]['ContractName'] ?? ''}",
                                      style: cardSubTitle,
                                    )),
                                SizedBox(
                                  width: displayWidth(context) * 0.08,
                                  child:
                                      const Text("Building", style: cardTitle),
                                ),
                                SizedBox(
                                    width: displayWidth(context) * 0.16,
                                    child: Text(
                                      ": ${trackVale[0]['BuildingName'] ?? ''}",
                                      style: cardSubTitle,
                                    )),
                                SizedBox(
                                  width: displayWidth(context) * 0.08,
                                  child: const Text("Spot", style: cardTitle),
                                ),
                                SizedBox(
                                    width: displayWidth(context) * 0.16,
                                    child: Text(
                                ...
                                SizedBox(
                                  width: displayWidth(context) * 0.08,
                                  child: const Text("Location(Site)",
                                      style: cardTitle),
                                ),
                                SizedBox(
                            ...
                            Row(children: [
                              SizedBox(
                                width: displayWidth(context) * 0.08,
                                child: const Text("Floor", style: cardTitle),
                              ),
                              SizedBox(
                                  width: displayWidth(context) * 0.16,
                                  child: Text(
                              ...
                              SizedBox(
                                width: displayWidth(context) * 0.08,
                                child: const Text("Division", style: cardTitle),
                              ),
                              SizedBox(
                                  width: displayWidth(context) * 0.16,
                                  child: Text(
