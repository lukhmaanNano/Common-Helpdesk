...
class _ServiceRequestState extends State<ServiceRequest> {
  ...
  int imagePageIndex = 0, step = 1;
  DateTime selectedDate = DateTime.now(), current = DateTime.now();
  TimeOfDay selectedTime = TimeOfDay.now();
  TimeOfDay fromTime = TimeOfDay.now();
  bool assetRelated = false,sign=true,isRecorderReady =false,isPlaying=false,showAudio=false;
  Duration totalDuration=Duration.zero,position=Duration.zero;
  Timer? _timer;
      ...
      for (var file in result.files) {
        ...
        if (file.bytes != null) {
          ...
          if(fileBytes.length >= 6){
            StackDialog.show('Maximum Image 5', 'Please Select 5 Image Only',
                Icons.image, trending4);
            fileBytes.clear();
          }
          else{
  ...
  Future<void> datePicker(BuildContext context) async {
    ...
    if (pickedDate != null) {
      ...
      _dateTimeController.text = DateFormat('yyyy-MM-dd kk:mm').format(DateTime(
          selectedDate.year,
          selectedDate.month,
          selectedDate.day,
          selectedTime.hour,
  ...
  void _handleSaveButtonPressed() async {
    ...
    await signatureGlobalKey.currentState!.toImage(pixelRatio: 3.0);
     signatureBytes = (await data.toByteData(format: ui.ImageByteFormat.png));
    setState(() {
      sign=false;
    });
  }
  ...
  final audioFile = File(path!);
    ...
    audioPlayer.play(DeviceFileSource(audioFile.toString()));
  }
 ...
 String formatTime(Duration totalDuration){
   String twoDigits (int n)=>n.toString().padLeft(2, '0');
   final hours=twoDigits(totalDuration.inHours);
   final minutes = twoDigits(totalDuration.inMinutes.remainder(60));
   final seconds = twoDigits(totalDuration.inSeconds.remainder(60));
   return [
     if(totalDuration.inHours > 0)hours,minutes,seconds
   ].join(':');
        ...
        leading: IconButton(
          ...
          onPressed: () {
            if (step == 1) {
              ...
              _countControl.countApi(context);
            } else {
              setState(() {
                  ...
                  child: Column(children: [
                        ...
                        children: [
                          ...
                          CircleAvatar(
                            ...
                            child: Icon(Icons.looks_two_rounded,
                                size: 15,
                                color:
                                    step == 1 ? secondaryColor : Colors.white),
                          ),
                          SizedBox(
                              width: displayWidth(context) * 0.28,
                              child: Divider(
                          ...
                          CircleAvatar(
                            ...
                            child: Icon(Icons.looks_3_rounded,
                                size: 15,
                                color:
                                    step == 3 ? Colors.white : secondaryColor),
                          ),
                        ],
                      ),
                    ),
                    Padding(
                      ...
                      child: Row(
                        ...
                        children: [
                          const Text('Property', style: inputHeader),
                          SizedBox(width: displayWidth(context) * 0.10),
                          const Text('Complaint', style: inputHeader),
                          SizedBox(width: displayWidth(context) * 0.10),
                          const Text('Details', style: inputHeader)
                        ],
                      ),
                    ),
                    const Padding(
        ...
        children: [
          SizedBox(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.spaceBetween,
                children: [
                  headerNonMandatoryName('Description'),
                                                        ...
                                                        SizedBox(
                                                          width: kIsWeb == true
                                                              ...
                                                              : MediaQuery.of(
                                                                  ...
                                                                  0.85,
                                                          child: Text(
                                                              _assetControl.assetData[index]['AssetTagNo'] ??
                                                                  '',
                                                              style:
                                                                  tileHeader),
                                                        ),
                  ...
                  Padding(
                    ...
                    child: RichText(
                      text: const TextSpan(
                        ...
                        style: statusHead,
                        children: <TextSpan>[
                          TextSpan(text: 'Open', style: statusContent),
                        ],
                      ),
                    ),
                  ),
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          building(
                              double.infinity, displayWidth(context) * 0.1),
                          floor(double.infinity, displayWidth(context) * 0.1),
                          spot(double.infinity, displayWidth(context) * 0.1),
                        ],
                      ),
                    ),
                  ),
                      ...
                      child: Card(
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            assetName(
                                double.infinity, displayWidth(context) * 0.1),
                            make(double.infinity, displayWidth(context) * 0.1),
                            model(double.infinity, displayWidth(context) * 0.1),
                            condition(
                                double.infinity, displayWidth(context) * 0.1),
                            status(
                                double.infinity, displayWidth(context) * 0.1),
                ...
                child: Column(
                  children: [
                    Column(
                      ...
                      children: [
                        const Padding(
                          padding: EdgeInsets.only(left: 16.0,bottom:10.0, top: 16),
                          child: Text(
                            "Media",
                            style: cardHeading,
                          ),
                                            ...
                                            children: [
                                              Padding(
                                                ...
                                                child: ClipRRect(
                                                    borderRadius:
                                                    const BorderRadius.all(Radius.circular(12)),
                                                    child: Image.memory(fileBytes[0],fit: BoxFit.cover)),
                                              ),
                                              Align(
                                                    ...
                                                    children: [
                                                      Padding(
                                                        ...
                                                        child: ClipRRect(
                                                            borderRadius:
                                                            const BorderRadius.all(Radius.circular(12)),
                                                            child: Image.memory(fileBytes[1],fit: BoxFit.cover)),
                                                      ),
                                                      Align(
                                                        alignment: Alignment.topRight,
                                                        child: IconButton(
                                                            onPressed: () {
                                                              fileBytes.removeAt(1);
                                                              imgName.removeAt(1);
                                                              myList.removeAt(1);
                                                            },
                                                            icon: const Icon(
                                                      ...
                                                      children: [
                                                        Padding(
                                                          ...
                                                          child: ClipRRect(
                                                              borderRadius:
                                                              const BorderRadius.all(Radius.circular(12)),
                                                              child: Image.memory(fileBytes[2],fit: BoxFit.cover)),
                                                        ),
                                                        Align(
                                                          alignment: Alignment.topRight,
                                                          child: IconButton(
                                                              onPressed: () {
                                                                fileBytes.removeAt(2);
                                                                imgName.removeAt(2);
                                                                myList.removeAt(2);
                                                              },
                                                              icon: const Icon(
                                                        ...
                                                        if(fileBytes.length > 3)
                                                          Align(
                                                            ...
                                                            child: Container(
                                                                height:25,width:25,
                                                                margin:const EdgeInsets.only(bottom:7.0,right:8.0),
                                                                decoration: BoxDecoration(
                                                                  color:Colors.black.withOpacity(0.5),
                                                                  borderRadius: BorderRadius.circular(5.0),
                                                                ),
                                                                child:Center(
                                                                    child: Text('+${fileBytes.length - 3}',
                                              ...
                                              stream:recorder.onProgress,
                                                builder: (context,snapshot) {
                                                  final duration = snapshot
                                                      .hasData ? snapshot.data!.duration: Duration.zero;
                                                  String twoDigits (int n)=>n.toString().padLeft(2, '0');
                                                  final twoDigitMinutes = twoDigits(duration.inMinutes.remainder(60));
                                                  final twoDigitSeconds = twoDigits(duration.inSeconds.remainder(60));
                                                      return Text('$twoDigitMinutes : $twoDigitSeconds',style:const TextStyle(fontSize:15,fontWeight:FontWeight.w500,color:red));
                                                }
                                            ),
                                            const Text('Record / Play Audio'),
                                          ],
                                        )),
                                    Expanded(
                                      flex: 1,
                                      child: InkWell(
                                        ...
                                        child: Icon(recorder.isRecording ? Icons.record_voice_over:Icons.add_circle_rounded,
                                            color: secondaryColor),
                                      ),
                                    )
                                  ]),
                              ...
                              children: [
                                IconButton(onPressed: ()async{
                                  if(isPlaying){
                                    ...
                                    String url ='/data/user/0/com.commonHelpdesk.commonhelpdesk/cache/audio';
                                     audioPlayer.play;
                                  }
                                },
                            ...
                            child: InkWell(
                              ...
                              child: const Row(
                                  ...
                                  children: [
                                    ...
                                    Expanded(
                                        flex: 3, child: Text('Record / Play Video')),
                                    Expanded(
                                      flex: 1,
                                      child: Icon(Icons.add_circle_rounded,
                                          color: secondaryColor),
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        Row(mainAxisAlignment: MainAxisAlignment.end, children: <Widget>[
                          TextButton(
                            style:ButtonStyle(
                              overlayColor:MaterialStateProperty.all(secondaryColor.withOpacity(0.1)),
                            ),
                            onPressed: _handleClearButtonPressed,
                            child: const Text('Clear',style:TextStyle(color:secondaryColor)),
                          ),
                          FilledButton.tonal(
                              style:ButtonStyle(
                                backgroundColor: MaterialStateProperty.all(secondaryColor.withOpacity(0.8)),
                              ...
                              onPressed: _handleSaveButtonPressed, child: const Text('Save')
                          )
                        ]),
                      ],
                    ),
                        ...
                        child: PhysicalModel(
                            ...
                            child: ClipRRect(
                              ...
                              Image.memory(
                                  ...
                                  signatureBytes!.buffer.asUint8List()),
                            ))),
