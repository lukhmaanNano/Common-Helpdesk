...
class _DashboardState extends State<Dashboard> {
  ...
  bool isPressed = false, profile = false, count = false;
    ...
    if (response.statusCode == 400) {
      ...
      if (statusVal == "200") {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
              builder: (context) => Login(un: 'null', pass: 'null')),
        );
      } else {
        final datas = jsonDecode(response.body);
                                        ...
                                        children: [
                                          SizedBox(
                                            ...
                                            child: Column(
                                              children: [
                                                Text(
                                                    '${_countControl.countData.isEmpty ? 0 : _countControl.countData[0]['AllCount']}',
                                                    style: dCardHead),
                                                const Text(
                                                  "Raised Requests",
                                                  style: dCardContent,
                                          ...
                                          SizedBox(
                                            ...
                                            child: Column(
                                              children: [
                                                Text(
                                                    '${_countControl.countData.isEmpty ? 0 : _countControl.countData[0]['OpenCount']}',
                                                    style: dCardHead),
                                                const Text(
                                                  "Open Requests",
                                                  style: dCardContent,
                                          ...
                                          SizedBox(
                                            ...
                                            child: Column(
                                              children: [
                                                Text(
                                                  '${_countControl.countData.isEmpty ? 0 : _countControl.countData[0]['ClosedCount']}',
                                                  style: dCardHead,
                                                ),
                                                const Text(
                                                  "Closed Request",
